...
from sklearn.preprocessing import StandardScaler  # No longer required but left for future use
import pandas as pd
import os
...
# Train model using dynamically created features with Random Forest
def train_model_dynamically(features, labels, tournament_data):
    ...
    # Drop 'Year' column for model training
